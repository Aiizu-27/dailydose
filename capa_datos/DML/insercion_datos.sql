...
(1, 'Cruasán de Mantequilla', 1, NULL, 2.50, 25, 2, 'assets/img/productos/croissant_mantequilla.webp'),
(2, 'Cinnamon Roll de Canela', 1, NULL, 3.80, 4, 2, 'assets/img/productos/cinnamon_roll.webp'),
(3, 'Tostada de Aguacate y Feta', 2, NULL, 6.50, 15, 2, 'assets/img/productos/brunch_aguacate.webp'),
(4, 'Sandwich de Pastrami Premium', 2, NULL, 8.90, 10, 2, 'assets/img/productos/brunch_pastrami.webp'),
(5, 'Flat White', 3, 2, 3.20, 450, 1, 'assets/img/productos/cafe_flatwhite.webp'),
(6, 'Café Latte Tradicional', 3, 2, 3.00, 500, 1, 'assets/img/productos/cafe_latte.webp'),
(7, 'Cappuccino Cremoso', 3, 2, 3.20, 400, 1, 'assets/img/productos/cafe_cappuccino.webp'),
(8, 'Rose Latte Edición Especial', 4, 2, 4.20, 80, 1, 'assets/img/productos/autor_rose.webp'),
(9, 'Espresso Tonic de Lavanda', 4, 2, 4.50, 60, 1, 'assets/img/productos/autor_tonic.webp'),
(10, 'Iced Latte Supremo', 5, 2, 3.50, 300, 1, 'assets/img/productos/frios_icedlatte.webp'),
(11, 'Cold Brew Macerado 12h', 5, 1, 4.00, 40, 1, 'assets/img/productos/frios_coldbrew.webp'),
(12, 'Espresso Solo', 6, 2, 1.80, 600, 1, 'assets/img/productos/espresso_solo.webp'),
(13, 'Espresso Doble (Doppio)', 6, 2, 2.20, 600, 1, 'assets/img/productos/espresso_doble.webp'),
(14, 'Espresso Macchiato', 6, 2, 2.00, 550, 1, 'assets/img/productos/espresso_macchiato.webp'),
(15, 'Café Filtro V60 de Origen', 6, 1, 4.50, 60, 1, 'assets/img/productos/espresso_v60.webp'),
(16, 'Extra Shot Espresso', 7, 2, 0.80, 999, 1, 'assets/img/productos/extra_shot.webp'),
(17, 'Sirope de Vainilla Madagascar', 7, NULL, 0.50, 100, 1, 'assets/img/productos/extra_sirope.webp'),
(18, 'Suplemento Bebida de Avena', 8, NULL, 0.40, 200, 1, 'assets/img/productos/leche_avena.webp'),
(19, 'Suplemento Bebida de Almendra', 8, NULL, 0.40, 150, 1, 'assets/img/productos/leche_almendra.webp'),
(20, 'Tarta de Queso con Pistacho', 9, NULL, 5.50, 8, 2, 'assets/img/productos/postre_cheesecake.webp'),
(21, 'Cookie de Chocolate y Sal Maldón', 9, NULL, 2.90, 30, 2, 'assets/img/productos/postre_cookie.webp'),
(22, 'Té Matcha Latte Japonés', 10, NULL, 4.20, 120, 1, 'assets/img/productos/bebidas_matcha.webp'),
(23, 'Kombucha de Jengibre Natural', 10, NULL, 3.90, 45, 1, 'assets/img/productos/bebidas_kombucha.webp');
